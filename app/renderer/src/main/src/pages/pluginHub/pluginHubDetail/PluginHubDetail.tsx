...
import {HubExtraOperate} from "../hubExtraOperate/HubExtraOperate"
...
export interface PluginDetailInfoProps {
    type: "online" | "own" | "local"
    name: string
    uuid: string
}
...
export interface PluginHubDetailRefProps {
    /** 设置需要展示的插件详情 */
    handleSetPlugin: (info: PluginDetailInfoProps) => any
    /** 清除正在展示的插件详情 */
...
export const PluginHubDetail: React.FC<PluginHubDetailProps> = memo(
    forwardRef((props, ref) => {
        ...
        const currentRequest = useRef<PluginDetailInfoProps | undefined>({
            type: "online",
        ...
        /** ---------- 获取插件信息逻辑 Start ---------- */
        const handleSetPlugin = useMemoizedFn((info: PluginDetailInfoProps) => {
                            ...
                            <TabPane tab='线上' key='online' disabled={!hasOnline}>
                                <div className={styles["tab-pane-wrapper"]}>
                                    <PluginDetailHeader
                                        ...
                                        extraNode={
                                            <>
                                                <HubExtraOperate getContainer={wrapperId} />
                                                {/* <OnlineExtraOperate
                                                data={plugin}
